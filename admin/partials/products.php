...
if(isset($_POST['btn_create'])) {
    ...
    $pathName = strtolower($path[0]->categoryTypeName);
        ...
        $products->insertColors($prodId, $_POST['colors']);
}
...
<div class="categoryAdmin">
    ...
    <?php
        foreach($productList as $singleProd) {
            ...
            echo '<td class="btns"><a href="?p=delCat&catId='.$singleProd->categoryId.'"><i class="material-icons">delete</i></a>  <a href="?p=redigerKategori&catId='.$singleProd->productId.'"><i class="material-icons">create</i></a></td>';
            echo '</tr>';
        }
    ?>
